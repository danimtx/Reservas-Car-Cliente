          ...
          {reservas.map((reserva) => (
            <div key={reserva.reservas.id} className="reserva-card">
              ...
              <div className="reserva-info">
                ...
                <p><strong>Fecha de Inicio:</strong> {reserva.reservas.fechaInicio}</p>
                <p><strong>Fecha de Fin:</strong> {reserva.reservas.fechaFin}</p>
                <p><strong>Monto:</strong> ${reserva.reservas.monto.toFixed(2)}</p>
              </div>
